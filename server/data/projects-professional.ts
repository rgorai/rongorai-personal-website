...
const data: PageData = [
  Tag(HtmlTag.H1, 'Professional Projects'),

  Component(ComponentName.UpdatedOn, { date: 'February 15, 2026' }),

  Tag(HtmlTag.H2, 'Code Climate'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.H3, 'Metrics Explorer V2'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.H3, 'Admin Portal Migration'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.H3, 'Testing Infrastructure'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.H3, 'Production Ownership'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.A, 'Code Climate homepage', {
  ...
  Tag(HtmlTag.H3, 'Assist (AI Assistant)'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.H3, 'Foundational Systems'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.A, `CyberConvoy homepage`, {
  ...
  Tag(HtmlTag.H3, 'The Idea Dashboard'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.H3, 'AI-Powered Market Intelligence'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.H3, 'Collaboration & Discovery'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.A, `NeuraFlash homepage`, {
  ...
  Tag(HtmlTag.A, 'More on IBM Db2 Migration Service', {
  ...
  Tag(HtmlTag.A, 'My research on testing platforms', {
  ...
  Tag(HtmlTag.A, 'ZAIS Group homepage', {
  ...
  Tag(HtmlTag.A, 'My Spring 2020 ZAIS Project Report', {
  ...
  Tag(HtmlTag.H2, 'KOVID Analytics'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.A, 'My KOVID Project Report', {
