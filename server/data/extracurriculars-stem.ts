...
const data: PageData = [
  ...
  Component(ComponentName.UpdatedOn, { date: 'December 11, 2023' }),
  ...
  Tag(HtmlTag.A, 'More about SpaceX CRS-10', {
    href: 'https://en.wikipedia.org/wiki/SpaceX_CRS-10',
    ...openLinkInNewTab,
  }),
  Tag(
    HtmlTag.P,
    `At the end of the program, NASA held a ceremony at CCM for all HUNCH students from the surrounding area. Here, I learned more about our impact at NASA and met astronaut Clayton Anderson.`
  ),
  Tag(HtmlTag.A, 'OSHE Article on the HUNCH Program', {
  ...
  Tag(HtmlTag.H3, 'PTC Design Challenge'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.A, 'My PTC Design Challenge Report', {
  ...
  Tag(HtmlTag.H3, 'Montville FIRST Outreach'),
  Tag(
    HtmlTag.P,
