...
const data: PageData = [
  Tag(HtmlTag.H1, 'About This Website'),

  Component(ComponentName.UpdatedOn, { date: 'February 20, 2023' }),

  Tag(HtmlTag.H2, 'Summary'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.A, 'Personal Website Repository', {
    href: 'https://github.com/rgorai/rongorai-personal-website',
    ...openLinkInNewTab,
  }),

  Tag(HtmlTag.H2, 'Description'),
  Tag(
    HtmlTag.P,
  ...
  Component(ComponentName.BulletedList, {
    items: [
  ...
  Tag(HtmlTag.H2, 'Release Notes'),

  Tag(HtmlTag.H3, '2.0 (Upcoming Ideas)'),
  Component(ComponentName.BulletedList, {
    items: [
