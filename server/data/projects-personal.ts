...
const data: PageData = [
  Tag(HtmlTag.H1, 'Personal Projects'),

  Component(ComponentName.UpdatedOn, { date: 'May 3, 2023' }),

  Tag(HtmlTag.H2, 'NPM Packages'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.A, 'Visit my NPM Package Platform', {
    href: 'https://rgorai-npm-packages.netlify.app',
    ...openLinkInNewTab,
  }),

  Tag(HtmlTag.H3, 'Complex Form Generator'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.A, 'View complex-form-generator on NPM', {
    href: 'https://www.npmjs.com/package/complex-form-generator',
    ...openLinkInNewTab,
  }),

  Tag(HtmlTag.H3, 'ESLint Config'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.A, 'View @rgorai/eslint-config on NPM', {
    href: 'https://www.npmjs.com/package/@rgorai/eslint-config',
    ...openLinkInNewTab,
  }),

  Tag(HtmlTag.H2, 'Personal Website'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.H2, 'Web Programming II Final Project: TitansChat'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.A, 'TitansChat Repository', {
    href: 'https://github.com/matttarantino/TitanChat',
    ...openLinkInNewTab,
  }),
  Tag(HtmlTag.A, 'TitansChat Proposal', {
  ...
  Tag(HtmlTag.H2, 'Web Programming I Final Project: MediaHub'),
  Tag(
    HtmlTag.P,
  ...
  Tag(HtmlTag.A, 'MediaHub Repository', {
  ...
  Tag(HtmlTag.A, 'MediaHub Proposal', {
    href: getDocument('/projects/personal/mediahub-proposal.pdf'),
    ...openLinkInNewTab,
  }),
  Tag(HtmlTag.A, 'MediaHub Pitch Slides', {
